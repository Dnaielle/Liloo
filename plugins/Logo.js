let handler = async (m, { conn, args, text, usedPrefix, command }) => {
	let tee = `✳️ ضع كلام قصير\n\n📌 مثال  : *${usedPrefix + command}* Naksu`
	let too = `✳️ ضح الاشارة مع النص *+* \n\n📌 مثال : \n*${usedPrefix + command}* Naksu *+* BOT`
  ...
  handler.tags = ['maker'];
  handler.command = /^(لوغو1|لوغو2|لوغو3|لوغو4|لوغو5|لوغو6|لوغو7|لوغر8|لوغو9|لوغر10|لوغو11|لوغو12)$/i;
