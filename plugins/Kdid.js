...
let gitagptHandler = async (m, { text, usedPrefix, command }) => {
  if (!text && !(m.quoted && m.quoted.text)) {
    throw `يرجى تقديم بعض النص أو اقتباس رسالة للحصول على رد.  ضع في اعتبارك أن GitaGPT لا يزال في مرحلة الاختبار، لذلك قد يولد استجابات غير دقيقة في بعض الأحيان.`;
  }
