...
${usedPrefix + command} 1000`.trim()
    ...
    let status = `ماتت دجاجتك🪦`
      ...
      if (botScore < playerScore) {
        ...
        status = `دجاجتك الصغيرة ربحت 🪙 ${amount * 2} الذهب أكثر ثراء! 🐥`
      } else {
        users.credit -= amount * 1
        users.chicken -= 1
